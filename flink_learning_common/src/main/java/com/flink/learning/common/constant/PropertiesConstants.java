package com.flink.learning.common.constant;

/**
 * @description:
 * @author: fanyeuxiang
 * @createDate: 2020-03-23 11:26
 */
public class PropertiesConstants {

    public static final String FYX = "fyx";
    ...
    public static final String DEFAULT_KAFKA_GROUP_ID = "fyx";
